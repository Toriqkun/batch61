          ...
          <div class="col" id="konten">
            <div class="card">
              ...
              <div class="card-button d-flex justify-content-center">
                <button class="btn btn-dark btn-sm me-1 mb-1" style="width: 140px;">edit</button>
                <button class="btn btn-dark btn-sm  ms-1 mb-1" style="width: 140px;" onclick="getRemoveData(event)">delete</button>
              </div>
            </div>
          </div>
          `;
